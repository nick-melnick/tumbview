...
class CustomWebViewController: UIViewController, UIWebViewDelegate {
    ...
    fileprivate func setUpNavigationBar() {
        let backButton = UIBarButtonItem(title: NSLocalizedString("Back", comment: "Back button title"), style: .plain, target: self, action: #selector(CustomWebViewController.backButtonPressed(_:)))
